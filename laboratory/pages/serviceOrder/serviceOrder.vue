<template>
	<view class="page">
		<view class="top flex justify-center">
			<view class="content bg-white" :class="role===0?'content-user':'content-admin'">
				...
				<view class="btn add flex-direction flex align-center" v-if="role==0">
		...
		<view class="bottom">
			<view class="sort bg-white flex align-center" :class="role===0?'sort-user':'sort-admin'">
			...
			<view class="orderList">
				<view class="container" v-if="role==0">
					<view class="listItem align-center justify-center box-sizing" v-if="serviceOrderList!=null">
				...
				<view v-else class="flex justify-center" style="width: 100%;">
					<view class="container" v-if="role==1||role==3">
						<view class="listItem align-center justify-center box-sizing" v-if="serviceOrderList!=null">
							<view class="bg bg-blue"></view>
							...
							<view class="bott flex justify-between">
								<view class="choose flex">
									<view class="flex-sub btnT">
										<button class="cu-btn round bg-white blue text-blue" @click="toServiceOrderExamine(1)">
											点击审核
										</button>
									</view>
									<view class="flex-sub btnT">
